...
def css():
    return "body{margin:0;padding:2rem;background:#f7f7f8;color:#1f2937;font-family:system-ui,sans-serif;line-height:1.6}.doc{background:white;border:1px solid #e5e7eb;border-radius:14px;padding:1.25rem;margin-bottom:1.5rem;box-shadow:0 2px 8px rgba(0,0,0,.04)}.text{white-space:pre-wrap;background:#fafafa;padding:1rem;border-radius:10px;border:1px solid #e5e7eb}a.term{color:#111827;text-decoration:none;padding:0 .15rem;border-radius:4px}a.term.both{background:#d9fbe3;border-bottom:2px solid #22c55e}a.term.expected_only{background:#ffedd5;border-bottom:2px solid #fb923c}a.term.predicted_only{background:#dbeafe;border-bottom:2px solid #60a5fa}.legend{display:flex;gap:1rem;flex-wrap:wrap;margin:.75rem 0 1rem 0;font-size:.9rem}.swatch{width:1rem;height:1rem;display:inline-block;border-radius:4px;border:1px solid #d1d5db;margin-right:.25rem;vertical-align:middle}.swatch.both{background:#d9fbe3;border-color:#22c55e}.swatch.predicted_only{background:#dbeafe;border-color:#60a5fa}.swatch.expected_only{background:#ffedd5;border-color:#fb923c}table{width:100%;border-collapse:collapse;margin-top:.75rem;font-size:.9rem}th,td{border:1px solid #e5e7eb;padding:.45rem;vertical-align:top}th{background:#f3f4f6;text-align:left}.summary,.stats{color:#6b7280}"
