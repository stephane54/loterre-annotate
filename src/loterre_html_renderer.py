...
def main():
    ...
    b.add_argument("--cli", default="./src/loterre_cli.py"); b.add_argument("--text-root", default="../data/jsonl"); b.add_argument("--gold-root", default="./gold_cleaned"); b.add_argument("--outdir", default="./html_outputs")
